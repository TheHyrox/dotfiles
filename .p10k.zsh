# Generated by Powerlevel10k configuration wizard on 2024-06-09 at 16:26 CEST.
...
() {
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_DIR_PREFIX='\UE5FE '

  #####################################[ vcs: git status ]######################################
  # Branch icon. Set this parameter to '\UE0A0 ' for the popular Powerline branch icon.
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='\UE708 \UE725 '
